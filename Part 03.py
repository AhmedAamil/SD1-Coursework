...
# Part 01, 02, 03 # This .py file Cont. with file handling (Part 03)
...
def list_output (progression_type): # Defining function for Part 03 – List (extension)
...
Enter 'y' for yes or 'q' to quit and view results : ''')
            ...
            if user_input == 'Y':
                ...
                print('Part 3 :')
                txtFile = open('Progression.txt', 'r')
