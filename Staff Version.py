...
# Part 01  A - D # This .py file is an Alternative Staff Version or a backup includes the complete program of the specification.
# The program version should allow Staff Members to predict their progression outcome at the end of each academic year.
...
# Opening Text File (Part 03)
txtFile = open('Progression.txt', 'w')
...
def list_output (progression_type): # Defining function Lists (Part 02, Part 03, Part 04)
    ...
    progression_list.append(output) # Appending progression I/O Data to List
    dic_list.append(output) # Duplicating  progression_list for Dictionary
...
Enter 'y' for yes or 'q' to quit and view results : ''')
            ...
            if user_input == 'Y':
                ...
                txtFile.close() # Closing .txt file after writing
                ...
                print('\nPart 2 :')
                for count in progression_list: # Output retrieved from list using for loop
                    print (count)

                # Part 03 -  Text File (extension)
                print('\nPart 3 :')
                txtFile = open('Progression.txt', 'r') # Output retrieved from text file
